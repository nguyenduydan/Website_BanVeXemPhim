...
<!-- Hiển thị nội dung chỉnh sửa phim -->
<div class="row">
    <div class="col-xl-12 col-lg-12 mx-auto">
        ...
        <div class="text-end mb-4">
            <a class="btn btn-secondary" href="film.php">Quay lại</a>
        </div>

        <form action="film-edit-process.php" method="POST" enctype="multipart/form-data">
            <div class="row">
            ...
            <!-- Trường ẩn -->
            <input type="hidden" id="id_phim" name="id_phim" value="<?php echo $id_phim; ?>">
