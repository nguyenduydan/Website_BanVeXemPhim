        ...
        <form id="editShowtimeForm" action="../admin/controllers/code.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="time" class="form-control" id="gio_chieu" name="gio_chieu" value="<?php //echo htmlspecialchars($showtime['gio_chieu']); 
                                                                                                    ?>" required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-control" id="ma_phim" name="ma_phim" required>
                        ...
                        <option value="<?php //echo htmlspecialchars($film['id']); 
                                        ?>" <?php //echo ($film['id'] == $showtime['ma_phim']) ? 'selected' : ''; 
                                                                                        ?>>
