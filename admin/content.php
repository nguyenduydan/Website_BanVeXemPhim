...
$pagination = setupPagination($conn, 'baiviet', $records_per_page, $searchString);
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center pb-0">
                ...
                <a href="views/content/content-add.php" class="btn btn-lg me-5 btn-add"
                    ...
                    <table class="table table-striped table-borderless align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-xs font-weight-bolder">Chủ đề</th>
                                <th class="text-center text-uppercase text-xs font-weight-bolder">Tên bài viết</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <th class="text-center text-xs font-weight-bolder"><?= $item['ChuDeBV']; ?></th>
                                        <th class="text-center text-xs font-weight-bolder"><?= $item['TenBV']; ?></th>
                                        <th class="text-center text-s font-weight-bolder">
                                            <form action="controllers/content-controller.php" method="POST"
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <a class="btn btn-secondary m-0"
                                                ...
                                                href="views/content/content-detail.php?id=<?= $item['Id'] ?>">
                                                <i class="bi bi-info-circle"></i> Chi tiết
                                            </a>
                                            <a class="btn btn-info m-0"
                                                style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                                                href="views/content/content-edit.php?id=<?= $item['Id'] ?>">
                                                <i class="bi bi-pencil"></i> Sửa
                                            </a>
                                            <a class="btn btn-danger m-0 delete-btn" data-id="<?= $item['Id'] ?>"
                                                data-url="views/content/content-delete.php"
                                                style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
