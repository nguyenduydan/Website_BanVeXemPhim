            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0 ">
                    <table class="table table-striped table-borderless align-items-center mb-0">
                        <thead>
                            <tr>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mã slider</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <a class="btn btn-info m-0" data-bs-toggle="modal" data-bs-target="#editSliderModal"
                                        style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
                                        Sửa
                                    </a>
                                    <a class="btn btn-danger m-0" data-bs-toggle="modal" data-bs-target="#delSliderModal"
                                        style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
                                        Xóa
                                    </a>
                                </td>
            ...
            <div class="modal-body">
                <div class="col-xl-12 col-lg-12 mx-auto">
                    <form action="" method="POST">
                        <div class="row">
                            <!-- Cột 1: Tên slider và trạng thái -->
                            <div class="col-md">
                                <!-- Nhập tên slider -->
                                <div class="form-group mb-3">
                                    <label for="ten_the_loai">Tên slider</label>
                                    <input type="text" class="form-control" id="ten_the_loai" name="ten_the_loai" placeholder="Nhập tên slider" required>
                                </div>
...
<!--Modal xóa slider slider-->
<div class="modal fade" id="delSliderModal" tabindex="-1" aria-labelledby="delSliderModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delSliderModalLabel">Xóa slider slider</h5>
                <button type="button" class="btn btn-danger"
                    style="--bs-btn-padding-y: .2rem; --bs-btn-padding-x: .2rem; --bs-btn-font-size: .75rem;"
                    data-bs-dismiss="modal" aria-label="Close">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
