...
<div class="container mb-5">
    <div class="row flex-nowrap g-4 m-0">
                        ...
                        if ($resultShowtimes->num_rows > 0) {
                            ...
                            while ($showtime = $resultShowtimes->fetch_assoc()) {
                                ...
                                echo "<li class='time-link mb-3'>
                                        <a href='list-chair.php?id=" . urlencode($showtime['MaSuatChieu']) . "' class='btn'>" . date('H:i', strtotime($showtime['giochieu'])) . "</a>
                                    </li>";
        ...
        <div class="col-3 d-sm-none d-md-none d-lg-block mt-5">
