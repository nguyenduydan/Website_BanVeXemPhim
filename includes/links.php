...
<link rel="stylesheet" href="<?php echo $baseURL; ?>assets/css/style.css?v1.0">
<link rel="stylesheet" href="<?php echo $baseURL; ?>assets/css/login_signin.css?1.4">
...
<script src="<?php echo $baseURL; ?>assets/js/my-js.js?1.7"></script>